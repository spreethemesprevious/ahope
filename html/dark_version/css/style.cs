...
.gradient_btn, .boxed_green_btn, .boxed_green_btn_2, .hosting_brand .container .section_title .boxed_btn.boxed_green_btn, .header_wrap .sign_in_up_area .boxed_green_btn.boxed_btn, .hero_area .hero_content_wrapper .hero_content .boxed_btn, .boxed_blue_btn, .boxed_blue_btn_2, .hosting_brand .container .section_title .boxed_btn.boxed_blue_btn, .header_wrap .sign_in_up_area .boxed_blue_btn.boxed_btn, .single_blog_item_2 .boxed_btn, .call_to_action_area .boxed_btn, .packege_pricing_area .single_pakege .boxed_btn, .packege_pricing_area_2 .single_pakege_2 .boxed_btn, .single_service_item .boxed_btn, .service_area_2 .single_service_item_2 .boxed_btn, .service_area_4 .single_service_item_4 .boxed_btn, .hero_area_2 .hero_content_wrapper .hero_content .boxed_btn, .hero_area_4 .hero_content_wrapper .hero_content .boxed_btn_4 {
  position: relative;
  z-index: 1;
  -webkit-transition: all 0.3s ease-in-out;
  -moz-transition: all 0.3s ease-in-out;
...
.single_feature_item_9 {
  ...
  .single_feature_item_9:hover {
    ...
    -moz-box-shadow: 0px 0px 15px 0px rgba(0, 0, 0, 0.3);
    box-shadow: 0px 0px 15px 0px rgba(0, 0, 0, 0.3); }
    .single_feature_item_9:hover .boxed_btn {
      color: #304e73; }
    .single_feature_item_9:hover h3 {
      color: #3a2085; }
    .single_feature_item_9:hover p {
      color: #838bab; }
...
@media screen and (min-width: 991px) {
  ...
  .home_drop:hover .collapse.hid, .drop_notf_btn:hover .collapse.hid, .drop_cart_btn:hover .collapse.hid, .blog_drop:hover .collapse.hid, .page_drop:hover .collapse.hid, .hosting_drop:hover .collapse.hid {
    display: block;
    -webkit-transition: all 0.3s ease-in-out;
    -moz-transition: all 0.3s ease-in-out;
    -ms-transition: all 0.3s ease-in-out;
