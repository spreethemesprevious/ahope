...
.section_title_main, .quastion_answer_area .container-fluid .right_side, .blog_area_3 .section_title {
  margin-bottom: 80px; }
  .section_title_main h2, .quastion_answer_area .container-fluid .right_side h2, .blog_area_3 .section_title h2 {
    font-weight: 700;
  ...
  .section_title_main h3, .quastion_answer_area .container-fluid .right_side h3, .blog_area_3 .section_title h3 {
    color: #304e73;
    font-size: 24px;
    font-weight: 700;
    font-family: 'Fira Sans', sans-serif; }
...
@media only screen and (min-width: 768px) and (max-width: 991px) {
  ...
  .contact_area .contact_form {
    ...
    .contact_area .contact_form .boxed_btn {
      ...
      .contact_area .contact_form .boxed_btn:hover {
        background: #2cd63c; } }
.quastion_answer_area .container-fluid {
  margin: 0;
  padding: 0; }
  .quastion_answer_area .container-fluid .left_side {
    width: 50%;
    float: left; }
  .quastion_answer_area .container-fluid .right_side {
    width: 50%;
    float: left;
    height: 760px;
    margin: 0; }
